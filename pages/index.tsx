    ...
    },
    {
      ...
      children: (
        <>
          ...
          <p>
            Worked on a <strong>Vue</strong> app, that scores a given website (screenshot or URL) on a set of UIX design
            metrics researched in the Aalto User Interfaces department. I have upgraded <strong>Webpack</strong>
            configurations and frontend dependencies, implemented result dynamic plotting and improved backend logging.
          </p>
          <p>
