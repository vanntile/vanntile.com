...
image: '/images/images/banner-composited-typing-animation.png'
tags: 'css, tailwind, compositing, animation, keyframes, transform property'
---
...
its own layer using the `will-change` class, included below. This has the effect of
...
would change on hover because sometimes it's better to *keep it simple, stupid*).
