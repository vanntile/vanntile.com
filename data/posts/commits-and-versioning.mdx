...
tags: 'semantic commits, conventional commits, commitizen, commitlint, git hooks'
---
...
messages respect the standard rules, or, just as I usually do, extend the [conventional config](https://github.com/conventional-changelog/commitlint/tree/master/@commitlint/config-conventional)
...
fixing errors) with prettier, on *JavaScript-like* files.
...
<NextArticleSection title="How to properly start a dockerized Express project" link="express-starter" />
