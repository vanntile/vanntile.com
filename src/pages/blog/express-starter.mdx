...
```yaml title="./src/api/openapi.yml"
openapi: 3.0.0
info:
  title: project name
  version: '1.0'
...
```js title="src/utils/ServerError.mjs"
...
```js title="src/utils/middleware.mjs"
